...
struct Game {
    ...
    //MARK: - Adders
    mutating func addInitalCards(ids: [UUID]) -> Bool {
        for id in ids {
    ...
    mutating func calculateSuspectProbabilities() {
    ...
    mutating func calculateWeapondProbabilities() {
    ...
    mutating func calculateRoomProbabilities() {
